    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){
            public void onCheckedChanged(RadioGroup group,int checkedId){
                ...
                Toast.makeText(TMainActivity.this,checkButton.getText().toString()+
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(TMainActivity.this);
        builder.setTitle("提示");
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener()
        {
            ...
            {
                Toast.makeText(TMainActivity.this, "对话框“确定”按钮被点击" , Toast.LENGTH_SHORT).show();
            }
        }).setNegativeButton("取消", new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                Toast.makeText(TMainActivity.this, "对话框“取消”按钮被点击", Toast.LENGTH_SHORT).show();
            }
        }).create();

        final AlertDialog.Builder builder2 = new AlertDialog.Builder(TMainActivity.this);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(username.getText().toString())) {
                    Toast.makeText(TMainActivity.this, "用户名不能为空", Toast.LENGTH_SHORT).show();
                }
                else {
                    if (TextUtils.isEmpty(password.getText().toString())) {
                        Toast.makeText(TMainActivity.this, "密码不能为空", Toast.LENGTH_SHORT).show();
                    }
                    else{
